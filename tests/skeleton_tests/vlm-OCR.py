...
# Caching the model so it loads only once 
@st.cache_resource
def load_model():
    MODEL_PATH = "/workspace/PDF-AI/hf/hub/models--Qwen--Qwen2.5-VL-72B-Instruct-AWQ/snapshots/c8b87d4b81f34b6a147577a310d7e75f0698f6c2"
...
def generate_answer(images, question, model, sampling_params):
    ...
    system_msg = (
        "Your job is to extract text from given images. Return only the extracted text."
    )
